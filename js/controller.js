...
var LIST_SRC_COLLECTIONS_XQUERY = "list-collections.xqy?t=s";
...
$(function() {
    ...
    $("#source-tree").tree({
        ...
        data: {
            ...
            async: true,
            opts: {
                url: LIST_SRC_COLLECTIONS_XQUERY
            }
        },        
    ...
    //////////////////////////////////////////
    // TARGET TREE - if there is ever a way to refactor this, it would be good to do so!
    //////////////////////////////////////////
    ...
    $("#target-tree").tree({
        ...
        data: {
            ...
            async: true,
            opts: {
                url: LIST_TGT_COLLECTIONS_XQUERY
            }
        },        
